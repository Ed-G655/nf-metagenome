...
process CONCOCT_CSV_TO_TSV {
	...
	output:
 	path "*"
	tuple val(Sample_name), path( "concoct_${Sample_name}/${Sample_name}_concoct.contig2bin.tsv"), emit: concoct_tsv
	...
	perl -pe "s/,/\t/g;" ${CSV_concoct} > concoct_${Sample_name}/${Sample_name}_concoct.contig2bin.tsv
